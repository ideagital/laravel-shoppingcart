...
use Ideagital\Shoppingcart\Contracts\Buyable;
...
class CartItem implements Arrayable, Jsonable
{
     ...
     * @param array      $options
     */
    public function __construct($id, $name, $price, array $options = [],$vendor_id)
    {
        if(empty($id)) {
        ...
        $this->rowId = $this->generateRowId($id, $options,$this->vendor_id);
    }
    ...
    public function updateFromArray(array $attributes)
    {
        ...
        $this->vendor_id     = array_get($attributes, 'vendor_id', $this->vendor_id);
        $this->rowId = $this->generateRowId($this->id, $this->options->all(),$this->vendor_id);
    }
    ...
    public static function fromArray(array $attributes)
    {
        ...
        return new self($attributes['id'], $attributes['name'], $attributes['price'], $options,$attributes['vendor_id']);
    }
     ...
     * @return \Gloudemans\Shoppingcart\CartItem
     */
    public static function fromAttributes($id, $name, $price, array $options = [],$vendor_id)
    {
        return new self($id, $name, $price, $options,$vendor_id);
    }
     ...
     * @return string
     */
    protected function generateRowId($id, array $options,$vendor_id)
    {
        ksort($options);

        return md5($id . serialize($options).$vendor_id);
    }
